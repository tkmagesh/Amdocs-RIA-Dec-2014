describe("A Calculator", function(){
	...
	it("Should be able to add arry of numbers", function(){
		//Arrange
		var numbers1 = [10,30],
			numbers2 = [20,40],
			expectedResult = 100;
	...
	it("Should be able to add array of functions returning functions returning array of numbers in string format", function(){
		//Arrange
